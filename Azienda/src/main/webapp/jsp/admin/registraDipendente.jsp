	...
	<div class="ch-container">
    	<div class="row">
        	...
        	<div id="content" class="col-lg-10 col-sm-10">
				...
				<div class=" row">
					<form class="form-vertical" action="${pageContext.request.contextPath}/jsp/admin/doRegistraDipendente.jsp" method="post">
		                <fieldset>
		                    ...
		                    <div class="input-group input-group-sm">
		                        <span class="input-group-addon"><i class="glyphicon glyphicon-lock red"></i></span>
		                        <input type="text" id="stipendio" name="stipendio" class="form-control" placeholder="Stipendio">
		                    </div>
		                    <div class="clearfix"></div><br>
